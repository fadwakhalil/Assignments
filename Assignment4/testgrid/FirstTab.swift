...
//  testgrid
//
//  Created by Fadwa Khalil on 7/24/16.
...
protocol EngineDelegate {
    ...
    func engineDidUpdate(firsttab: FirstTab, didUpdateRows:Int)
    func engineDidUpdate(firsttab: FirstTab, didUpdateCols:Int)
}


class FirstTab : UIViewController,EngineProtocol {
    
    private static var _sharedInstance = FirstTab()
    static var sharedInstance: FirstTab {
        get {
